class Player {
  ...
  void display() {//DISPLAY///////////////
    ...
    if (state <0 && state >=-1){
     PImage leftB;
     leftB = loadImage("I1.png");//loadImage("lefta.png");
    ...
    //LEFTB
     ...
     PImage leftB;
     leftB = loadImage("I2.png");//loadImage("leftb.png");
     image(leftB, x, y-charYShift);
    }// END LEFTB
     ...
     //RIGHTA
      ...
      PImage rightA;
     rightA = loadImage("D1.png");//loadImage("righta.png");
    ...
    //RIGHTB
     ...
     PImage rightB;
     rightB = loadImage("D2.png");//loadImage("rightb.png");
    ...
    //STILL
     ...
     PImage still;
     still = loadImage("centro_1.png");//loadImage("still.png");
